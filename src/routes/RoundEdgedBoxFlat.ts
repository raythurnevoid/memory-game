/**
 * @see https://hofk.de/main/discourse.threejs/2021/RoundEdgedBoxFlat/RoundEdgedBoxFlat.html
 */

import * as THREE from 'three';

export default function RoundEdgedBoxFlat(w: number, h: number, t: number, r: number, s: number) {
